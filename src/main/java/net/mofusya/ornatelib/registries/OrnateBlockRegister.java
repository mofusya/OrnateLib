...
public class OrnateBlockRegister {
    ...
    public OrnateBlockRegister(String modId) {
        this(modId, 1);
    }

    public OrnateBlockRegister(String modId, int indexCount) {
        this.itemRegisters = new OrnateItemRegister(modId, indexCount);
    ...
    public RegistryObject<Block> register(String id, Builder builder, int index) {
        ...
        RegistryObject<Block> toReturn = this.blockRegisters.get(index).register(id, builder.block);
        ...
        this.itemRegisters.register(id, () -> builder.itemFunc.apply(toReturn.get(), builder.itemBuild), index);
    ...
    public RegistryObject<Block> register(String id, Supplier<Block> block, Item.Properties itemBuild, int index) {
        RegistryObject<Block> toReturn = this.blockRegisters.get(index).register(id, block);
        this.itemRegisters.register(id, () -> new BlockItem(toReturn.get(), itemBuild), index);
        return toReturn;
    }
    ...
    public DeferredRegister<Item> getItemRegister(int index) {
        return this.itemRegisters.getItemRegister(index);
    }
    ...
    public List<RegistryObject<Item>> getItems(int index) {
        return this.itemRegisters.getItems(index);
    }

    public List<RegistryObject<Item>> getItems(int... indexes) {
        return this.itemRegisters.getItems(indexes);
    }
    ...
    public DeferredRegister<Block> getBlockRegister(int index) {
        return this.blockRegisters.get(index);
    }
    ...
    public List<RegistryObject<Block>> getBlocks(int index) {
        return new ArrayList<>(this.getBlockRegister(index).getEntries());
    }

    public List<RegistryObject<Block>> getBlocks(int... indexes) {
        List<RegistryObject<Block>> toReturn = new ArrayList<>();
